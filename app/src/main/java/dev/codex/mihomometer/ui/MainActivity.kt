...
import dev.codex.mihomometer.dashboard.DashboardActivity
import dev.codex.mihomometer.overlay.TrafficOverlayService
import dev.codex.mihomometer.settings.AppThemeMode

class MainActivity : ComponentActivity() {
    private val viewModel: MainViewModel by viewModels {
        val container = (application as MihomoMeterApp).container
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            MihomoMeterTheme(themeMode = state.themeMode) {
